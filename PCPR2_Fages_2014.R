# Comparison of original script from Fages et al 2014 with new package
# load new package to be able to access transcriptomics test data
library(pcpr2)

# ORIGINAL PCPR2 SCRIPT (Fages et al 2014 supplemental data)
...
# Load data
X_DataMatrixScaled <- transcripts
Z_InterestFactors <- Y_metadata
...
bp <- barplot(pR2Sums, xlab = "", ylab = "Weighted Rpartial2", ylim = c(0,max(pR2Sums) * 1.3), 
              col = c("red"), las=2, main = "Output script Fages et al. 2014")
